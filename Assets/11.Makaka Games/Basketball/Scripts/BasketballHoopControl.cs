...
namespace MakakaGames.Basketball
{
    ...
    public class BasketballHoopControl : MonoBehaviour
    {
        ...
        public void InitBasketballNet(int countOfThrowingObjects)
        {
            basketballRingControl.InitNet(countOfThrowingObjects);
        }
        ...
        public void RegisterSphereColliderForNet(SphereCollider sphereCollider)
        {
            ...
            basketballRingControl.RegisterSphereCollider(sphereCollider);
        }
        ...
        public void AnnulSphereColliderForNet(SphereCollider sphereCollider)
        {
            ...
            basketballRingControl.AnnulSphereCollider(sphereCollider);
        }

        public void SetBigRing()
        {
            StartCoroutine(basketballRingControl.SetBigSize());
        }

        public void SetNormalRing()
        {
            StartCoroutine(basketballRingControl.SetNormalSize());
        }
    }
}