...
namespace MakakaGames.Publisher.FPSController
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        [SerializeField] private float m_WalkSensitivity = 1.5f;
        [SerializeField] private float m_Walkravity = 6f;
        [SerializeField] private float m_RunSpeed;
        [SerializeField] [Range(0f, 1f)] private float m_RunstepLenghten;
        
        [SerializeField] private Key m_JumpKey = Key.Space;
        ...
        private void Update()
        {
            ...
            if (!m_Jump)
            {
                m_Jump = Keyboard.current[m_JumpKey].wasPressedThisFrame;
            }
        ...
        private void FixedUpdate()
        {
            ...
            Physics.SphereCast(
                transform.position, m_CharacterController.radius, Vector3.down,
                // get a normal for the surface that is being touched to move along it
                out RaycastHit hitInfo, m_CharacterController.height / 2f,
            ...
            {
                m_MoveDir += 
                    m_GravityMultiplier * Time.fixedDeltaTime * Physics.gravity;
            }
        ...
        {
            Vector2 m_InputTarget = 
                new Vector2(GetAxis(Key.D, Key.A), GetAxis(Key.W, Key.S)) * m_WalkSensitivity;

            m_Input = Vector3.MoveTowards(m_Input, m_InputTarget,
                m_Walkravity * Time.deltaTime);

            bool waswalking = m_IsWalking;

            // On standalone builds, walk/run speed is modified by a key press.
            // keep track of whether or not the character is walking or running
            m_IsWalking = !Keyboard.current[Key.LeftShift].isPressed;
            ...
            // only if the player is going to a run, 
            // is running and the fovkick is to be used
                ...
                && m_CharacterController.velocity.sqrMagnitude > 0)
            {
                ...
                StartCoroutine(
                    !m_IsWalking ? m_FovKick.FOVKickUp() : m_FovKick.FOVKickDown());
            }
        }
