...
namespace MakakaGames.Publisher.AR.ARFoundationBase.SupportChecker
{
    /// <summary>
    ...
    public class ARFoundationSupportChecker : MonoBehaviour
    {
        ...
        [Tooltip("To test the App without XR Simulation")]
        [SerializeField]
        private bool isARUnsupportedInEditorTest;

        [Space]
        [SerializeField]
        private UnityEvent OnStartedInEditor;

        [Header("Not in Editor")]
        [SerializeField]
        ...
        [Space]
        [SerializeField]
        private UnityEvent OnARReadyActionButton = null;
        ...
        [Space]
        [SerializeField]
        private UnityEvent OnARSoftwareUpdateStarted = null;
        ...
        private void Start()
        {
            ...
            OnStartedInEditor?.Invoke();

            if (isARUnsupportedInEditorTest)
            {
                InitARIsNotSupported();
            }
            else if (isCheckedInEditorOnInit)
            {
                Check();
            }
            else
        ...
        {
            OnARSoftwareUpdateStarted?.Invoke();
